...
const GlobeDemo = dynamic(() => import("./Globe").then((mod) => mod.GlobeDemo), {
      ...
      <div className="flex flex-col mt-[90px] md:mt-[160px] font-light gap-6 lg:gap-10 pt-[10vw] pl-[6vw] lg:pl-[5vw] lg:pt-[5vw] w-full lg:max-w-[60%]">
        <div style={{ position: "relative", overflow: "hidden" }}>
          <h1
            ...
            className={`text-black uppercase text-[8vw] mb-5 lg:mb-6 md:text-[4.1vw] ${Rancher}`}
          >
            Your Trusted Partner <br />{" "}
            <span className="text-orange-500">for Success</span>
          </h1>
          <p className={`text-black pr-4 md:text-2xl ${SedaN}`}>
            ...
            solutions that help you succeed. Let’s team up and make your dreams a
            reality!
          </p>
        </div>
        ...
        <div style={{ transform: "none !important" }} className="hero_atc flex">
          <Link
            className={`md:text-xl flex transition-all ease-in-out bg-black px-[2rem] py-[.7rem] max-h-[3rem] h-[3rem] text-white rounded-full items-center justify-center ${SedaN}`}
            href="#portfolio"
          >
            View our portfolio
          </Link>
