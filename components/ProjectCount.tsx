...
const ProjectCount = () => {
  const fastText = "(*fast)";
  return (
    <div className="flex relative  rounded-t-md rounded-r-md  rounded-b-none bg-black lg:px-10 px-4 flex-col lg:h-[70vh] h-auto w-full justify-center items-start gap-6 lg:gap-12  ">
      <div className="flex lg:max-w-[70%] bg-black flex-col   justify-center items-start gap-12  ">
        ...
        <h2
          ...
          className={` ${Rancher}  text-[26px] md:text-[5vw] text-white`}
        >
        ...
        <div>
          ...
          <p className={` text-gray-300 md:text-xl ${SedaN} `}>
